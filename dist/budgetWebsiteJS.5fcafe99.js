...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"budgetWebsiteJS.js":[function(require,module,exports) {
"use strict";
...
function addDebt() {
  var debtElem = document.createElement('li');
...
function addExpense() {
  var expenseElem = document.createElement('li');
...
function calcBudget() {
  ...
  var debtCollection = document.getElementsByClassName('debtInputRow');
  var expenseCollection = document.getElementsByClassName('expenseInputRow');
  ...
  for (var i = 0; i < debtCollection.length; i++) {
    var debtInput = debtCollection[i].querySelector('.debtAmtInput');
  ...
  for (var _i = 0; _i < expenseCollection.length; _i++) {
    var expenseInput = expenseCollection[_i].querySelector('.expenseAmtInput');
    var expenseType = expenseCollection[_i].querySelector('.expenseSelectorInput').value;
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","budgetWebsiteJS.js"], null)
//# sourceMappingURL=/budgetWebsiteJS.5fcafe99.js.map